...
public final class ValidationUtils {
	...
	/**
	 * Checks whether patient's info is correct. See comments associated with
	 ...
	 */
	public static boolean checkPatientInfo(String firstName, String middleName, String lastName, int age, int weight,
		...
		if (!"male".equals(sex) && !"female".equals(sex.toLowerCase()) && !"none".equals(sex.toLowerCase())) {
			throw new IllegalArgumentException("Sex can only be either 'male', 'female', or 'none'.");
		}
//		
	...
	if(bloodType.equals(null)) {
		...
		// Check whether bloodType is either A+, A-, B+, B-, O+, O-, AB+, AB-, or
		// 'none'.
